...
\begin{tabularx}{\textwidth}{@{} l X lr lX @{}}
  ...
  {Washington, DC} & &
      ...
      \textbf{gpg} & \href{https://pgp.mit.edu/pks/lookup?op=get\&search=0x68E925EE1DFE3B2C}{0x1DFE3B2C} \\
\end{tabularx}
...
\begin{tabularx}{\textwidth}{@{} lX @{}}
  ...
  \textbf{libraries} & sklearn, pandas, play, akka (streams, actors), alpakka, cats, react \\
  \textbf{data} & dagster, postgres, elasticsearch, redis, hdfs \\
  \textbf{devops} & kubernetes, docker, terraform, helm, jenkins, datadog \\
  \textbf{aws} & IAM, SSO, Cognito, EKS, EC2, RDS, Neptune, S3, Route53, VPC \\
...
\noindent\begin{tabularx}{\textwidth}{@{} Xr @{}}
  \textit{Zephyr AI} \{python, machine learning, healthcare\} & \\
  \textbf{Principal Software Engineer} & \textbf{04/2021 - present} \\
\end{tabularx}

\begin{itemize}
\item Designed, deployed, and maintained Kubernetes cluster on AWS EKS with Terraform.
\item Implemented continuous delivery from source code to production using GitLab pipelines.
\item Architected and implemented complex data processing graphs with Dagster and Python.
\end{itemize}
