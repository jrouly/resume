...
%  \end{details}
  ...
  \noindent
  \begin{details}
    \item Languages: Java, C, Python, SQL, R, PHP, (X)HTML, CSS, Javascript, Haskell, MATLAB, \LaTeX
    \item Notable Libraries: Apache Hadoop and Mahout, Django, SVN, Git, JQuery, Eclipse, NetBeans
    \item Operating Systems: Linux/UNIX; Windows 7, XP, 2000
    \item Software Engineering: MapReduce, Use Case analysis, UML, technical writing
  \end{details}
