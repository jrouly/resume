...
% \noindent\begin{center}``Usability and Suitability of Features in Visual IDEs for Non-Programmers''\end{center}
...
%  \end{details}
  ...
  Non-Programmers. In Proceedings of the 5th Workshop on Evaluation and
  Usability of Programming Languages and Tools, PLATEAU '14, pages 31–42,
